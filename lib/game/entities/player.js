...
.defines(function() {
  EntityPlayer = ig.Entity.extend({
    ...
    health: 1,
    bumpSound: new ig.Sound('media/audio/smb_bump.ogg',true),
    dieSound: new ig.Sound('media/audio/smb_playerdie.ogg',true),
    jumpSound: new ig.Sound('media/audio/smb_jump_small.ogg',true),
    jumpSuperSound: new ig.Sound('media/audio/smb_jump_super.ogg',true),
    coinSound: new ig.Sound('media/audio/smb_coin.ogg',true),
    growSound: new ig.Sound('media/audio/smb_powerup.ogg',true),
    pipeSound: new ig.Sound('media/audio/smb_pipe.ogg',true),
    animSheet: new ig.AnimationSheet('media/sprites/mario.png', 16, 32),
    init: function(x, y, settings) {
      ...
      this.addAnim('grow1', 0.03, [7,0]);
      this.addAnim('grow2', 0.03, [7,32]);
    ...
    update: function() {
      if (this.active) {
        if (this.health > 0 && ig.game.alive) {
          ...
          this.speed = ig.game.super ? 180 : 150;

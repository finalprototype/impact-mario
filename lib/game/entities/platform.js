...
EntityPlatform = ig.Entity.extend({
  ...
  animSheet: new ig.AnimationSheet( 'media/sprites/platform-long.png', 48, 8 ),
  ...
  init: function(x,y,settings) {
    ...
    this.animSheet = new ig.AnimationSheet( 'media/sprites/platform-long.png', this.length, 8 ),

...
Mario = ig.Game.extend({
  ...
  gameoverSound: new ig.Sound('media/audio/smb_gameover.ogg',false),
  coinSound: new ig.Sound('media/audio/smb_coin.ogg',false),
  lifeSound: new ig.Sound('media/audio/smb_1_up.ogg'),
  pauseSound: new ig.Sound('media/audio/smb_pause.ogg'),
  clearSound: new ig.Sound('media/audio/smb_stage_clear.ogg'),
  worldClearSound: new ig.Sound('media/audio/smb_world_clear.ogg'),
  onswipeMusic: new ig.Sound('media/music/music-onswipe.ogg'),
  invincibleMusic: new ig.Sound('media/music/starman.ogg'),
